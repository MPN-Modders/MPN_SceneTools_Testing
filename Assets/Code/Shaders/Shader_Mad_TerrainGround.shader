...
Shader "Madness/Terrain - Ground"{
	...
	[HideInInspector] _Color("Main Color", Color) = (1,1,1,1)
		...
		[HideInInspector] _TintColor("Tint Color", Color) = (0, 0, 0, 0) // Because this exists in the Secondary Light shader file, this gets added here just in case.
...
#line 21 ""
	...
	return c;
		...
		UsePass "Madness/StoredPasses/Secondary/SECONDARYTERRAIN_SIMPLE"
