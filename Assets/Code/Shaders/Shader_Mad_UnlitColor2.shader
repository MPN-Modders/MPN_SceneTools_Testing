...
Shader "Madness/Unlit Color (World Object) DO NO USE" { // This item will show a character's silhouette through it, unlike the standard Unlit.
	Properties {
		_MainTex ("Base (RGB)", 2D) = "white" {}
		_Color ("Color", Color) = (1,0,0,1)
	 		_Outline ( "Outline Thickness", Range (0.1, 0.1) ) = 0.1
